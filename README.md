...
```text
index.html                  主应用，包含 HTML、CSS 和交互逻辑
content.js                  双语文案、详情说明和宜忌规则
...
```text
index.html                  Main app: HTML, CSS, and interaction logic
content.js                  Bilingual copy, detail text, and almanac rules
